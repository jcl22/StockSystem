...
<head>
    ...
    <title>Ventas | Clientes / Lista</title>
...
<body>
    ...
    <section id="content-section">
        ...
        <!-- busqueda -->
        <form class="input-group rounded" action="buscadorclientes.php" method="get">
            ...
            <table>
                ...
                $query = mysqli_query($conn, "SELECT * FROM cliente WHERE estado=1 ORDER BY id_cliente 
                ASC");
                    ...
                    <tr class="datos-usuario">
                        ...
                        <td> <?php echo $data["telefono"] ?> </td>
                            ...
                            ?>
                                ...
                                <td class="buttons">
                                        <a href="2.3editarcliente.php?id=<?php echo $data["id_cliente"] ?>">
                                        ...
                                        <a href="2.4eliminarcliente.php?id=<?php echo $data["id_cliente"] ?>">

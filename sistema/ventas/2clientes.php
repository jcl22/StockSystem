    ...
    <section id="content-section" >
        <!-- <div class="container"> -->
            <div class="section-container">
                    ...
                    <!-- <div class="icono-section col-3 header-section wow fadeInUp"> -->
                        ...
                        <div class="botones-accion"> 
                            <div class="boton agregar-pro">
                                <a href="2.1agregarcliente.php" class="btn btn-primary">Crear proveedor</a>
                            </div>
                            <div class="boton agregar-pro">
                                <a href="2.2listaclientes.php" class="btn btn-primary">Lista de proveedores</a>
                            </div>
                        </div>   
                ...
                <div class="bg-icono">
                    <svg id="img-compras" xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">

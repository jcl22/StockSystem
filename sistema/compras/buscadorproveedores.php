...
<head>
    ...
    <title>Compras | Proveedores/Lista</title>
                    ...
                    <tr class="datos-usuario">
                        ...
                        <td> <?php echo $data["telefono"] ?> </td>
                            ...
                            ?>
                                ...
                                <td class="buttons">
                                        <a href="2.3editarproveedor.php?id=<?php echo $data["id_proveedor"] ?>">
                                        ...
                                        <a href="2.4eliminarproveedor.php?id=<?php echo $data["id_proveedor"] ?>">
            ...
            <div class="content">
                <div class="botones-abl-footer">
                    <div class="float-left boton wow pulse" data-wow-iteration="infinite" data-wow-duration="500ms">
                        <a href="2proveedores.php" class="boton btn btn-primary"><i class="fas fa-chevron-circle-left"></i></a>
                    </div>

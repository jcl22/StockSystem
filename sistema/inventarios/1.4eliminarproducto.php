...
<head>
    ...
    <title>Inventarios | Producto/Eliminar</title>
            ...
            <div class="content">
                <div class="eliminar">
                    <h3>
                        ...
                        Esto es importante. ¿Estás seguro de eliminar el producto?
                    </h3>
                    ...
                    <form class="buttons-eliminar" method="post" action="">
                        ...
                        <button href="1.3editarproducto.php" id="button-eliminar" type="submit" class="btn btn-danger">
        ...
        <div class="content">
            <div class="botones-abl-footer">
                <div class="float-left boton wow pulse" data-wow-iteration="infinite" data-wow-duration="500ms">
                    <a href="1.2listaproductos.php" class="boton btn btn-primary"><i class="fas fa-chevron-circle-left"></i></a>
                </div>
